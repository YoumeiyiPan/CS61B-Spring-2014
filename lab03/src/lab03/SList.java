 ...
 /*
  ...
  public static void main (String[] args) {
    // Fill in your solution for Part I here.
	   System.out.println("Here is my solution for Part I : " );
   SList ls=new SList(); 
   ls.insertFront(new Integer(12));
   ls.insertFront(new Integer(9));
   ls.insertFront(new Integer(6));
  
   System.out.println("The list should be 6, 9, 12: "
		       + ls.toString());
   TestHelper.verify(ls.toString().equals("[  6  9  12  ]"),
		      "InsertFronts on non-empty list failed");
   ls.insertFront(new Integer(3));
   ls.insertEnd(new Integer(15));
   System.out.println("After adding more lines to the list, it should be 3, 6, 9, 12, 15: "
	       + ls.toString());
TestHelper.verify(ls.toString().equals("[  3  6  9  12  15  ]"),
	      "InsertFronts on non-empty list failed");
